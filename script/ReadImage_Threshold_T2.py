...
class ReadImage_Threshold_T2:
    ...
    def OnRunning_Event():
        ...
        ReadImage_Threshold_T2.thread = Thread(target=ImageAcqDLL.ReadImage, args=(ReadImage_Threshold_T2.imageAcqHandle\
                                                                                   ,r'D:\straight_edge.bmp'\
                                                                                   , byref(ReadImage_Threshold_T2.image),))
    ...
    def Action():
        ...
        ReadImage_Threshold_T2.thread = Thread(target=ThresholdDLL.Action(), args=())
        ReadImage_Threshold_T2.thread.start()
        ScriptPlugin.updateThreadInfo('ReadImage_Threshold_T2', 'thread', None)
